...
class SwinMambaBlock(nn.Module):
    r""" Swin-Mamba and Swin-transformer Block.
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=28, shift_size=0,
        ...
        #self.attn = WindowMamba2D(dim=dim, window_size=(4, 7, 7), mamba_config={"dt_rank": "auto","expand": 2})
...
class RSMB(nn.Module):
    """Residual Swin Mamba Block (RSMB).
...
# class Mamba_backbone(nn.Module):
#     def __init__(self,
#                  in_chans=3,
#                  embed_dim=96,
#                  depths=[6, 6, 6, 6],
...
#                  **kwargs):
#         super(Mamba_backbone, self).__init__()
#         num_in_ch = in_chans
#         num_out_ch = in_chans
#
...
#
#         scan_transform = ScanTransform('diagonal', 8, 'concate')
#
#
#
#
...
#             layer = MambaFormerBlock(dim=embed_dim,  layernorm_type='WithBias', scan_transform=scan_transform)
